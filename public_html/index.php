          ...
          <div class="rev_slider" data-version="5.0">
            <ul>
              ...
              <li data-index="rs-1" data-transition="slidingoverlayhorizontal" data-slotamount="default" data-easein="default" data-easeout="default" data-masterspeed="default" data-thumb="http://placehold.it/1920x1281" data-rotate="0" data-saveperformance="off" data-title="Web Show" data-description="">
                <!-- MAIN IMAGE -->
                <img src="/uploads/slide-1.jpg"  alt=""  data-bgposition="center center" data-bgfit="cover" data-bgrepeat="no-repeat" class="rev-slidebg" data-bgparallax="6" data-no-retina>
                <!-- LAYERS -->
                    ...
                    <div class="cd-timeline-content bounce-in">
                        <div class="row equal-height">
                            ...
                            <div class="col-sm-4 pl-0 pl-sm-15 sm-height-auto" style="min-height: 10.5em;">
                                <div class="cd-content-right p-15">
                                    <ul class="cd-timeline-meta mt-sm-0">
                                        <li><i class="fa fa-clock-o"></i> 18:00 - 21:00 <a href="https://time.is/Amsterdam" target="_blank">CET</a></li>
                                        <li><i class="fa fa-thumb-tack"></i> <a href="https://github.com/modxcms/revolution/issues/" target="_blank">Github</a> + <a href="https://modx.org" target="_blank">Slack (#modxbughunt)</a></li>
                                    </ul>
                                </div>
                            </div>
                    ...
                    <div class="cd-timeline-content bounce-in">
                        <div class="row equal-height">
                            ...
                            <div class="col-sm-4 pl-0 pl-sm-15 sm-height-auto" style="min-height: 10.5em;">
                                <div class="cd-content-right p-15">
                                    <ul class="cd-timeline-meta mt-sm-0">
                                        <li><i class="fa fa-clock-o"></i> 22:00 and onward</li>
                                        <li><i class="fa fa-thumb-tack"></i> <a href="https://github.com/modxcms/revolution/issues/" target="_blank">Github</a> + <a href="https://modx.org" target="_blank">Slack (#modxbughunt)</a></li>
                                    </ul>
                                </div>
                            </div>
              ...
              <div class="col-xs-12 col-md-4">
                  ...
                  <p>Everybody wins a prize thanks to <a href="https://modstore.pro" target="_blank">MODSTORE.pro</a> and <a href="https://modhost.pro" target="_blank">MODHOST.pro</a>. Every participant registered on the <a href="https://www.meetup.com/modx-bug-hunt/events/238613206/" target="_blank">Meetup.com event page</a> gets the following:</p>
                      <ul>
                          ...
                          <li>Free access to 3 paid extras on <a href="https://modstore.pro/" target="_blank">MODSTORE</a></li>
                      </ul>
                  ...
                  <ul>
                      ...
                      <li>A free 45 minute MODX Consultation, or 1x license of choice*, or a €100 discount on Commerce</li>
                  </ul>
                  <h4>Issue hustler</h4>
        ...
        <div class="section-content">
          <div class="row">
            <div class="col-md-6 col-md-offset-3">
              ...
              <script type='text/javascript' src='/js/mailch-validate.js'></script><script type='text/javascript'>(function($) {window.fnames = new Array(); window.ftypes = new Array();fnames[0]='EMAIL';ftypes[0]='email';fnames[1]='NAME';ftypes[1]='text';fnames[2]='COMPANY';ftypes[2]='text';}(jQuery));var $mcj = jQuery.noConflict(true);</script>
              <!--End mc_embed_signup-->
